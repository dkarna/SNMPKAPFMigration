...
,t1.CyCode AS tran_crncy_code  -- ct.CyDesc to be used to replace CyCode
,t1.DealAmt AS tran_amt
,'C' AS part_tran_type  -- D: Debit   C: Credit
,t1.DealOpenDate AS value_date -- possible value: ctb.Today  -- value will be changed to migration date
,'' AS agent_emp_ind
,'' AS agent_code
