...
--,case when fst.PumoriAcType='01' and fst.PumoriCyCode='01' and t1.Limit < 0 then '25055'
 ...
 ,case when t1.AcType='0V' then fst.FinacleSubGL else flt.FinacleSubGL end AS GL_Sub_Head_code
--,--fst.FinacleSchCode as  Schm_code
,case when t1.AcType='0V' then fst.FinacleSchCode else flt.FinacleSchCode end as  Schm_code
,'Y' Chq_alwd_flg
,'S' Pb_ps_code
...
,LEFT(t2.Address1,5) as  acct_loc_cod
