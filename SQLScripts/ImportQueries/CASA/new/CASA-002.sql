...
where M.BranchCode=P.BranchCode and M.AcType=P.AcType and M.CyCode=P.CyCode
and M.MainCode = m.MainCode) id_dr_pref_pcnt                        ,
...
convert(varchar,dateadd(dd,-30,LimitExpiryDate),105) lim_review_date                                        ,
...
' ' channel_id                                             ,
' ' channel_level_code                                     ,
RIGHT(SPACE(17)+CAST('0' AS VARCHAR(17)),17) int_suspense_amt                                       ,		--after bpd
RIGHT(SPACE(17)+CAST('0' AS VARCHAR(17)),17) Penal_int_Suspense_amt                                 ,		--after bpd
...
RIGHT(SPACE(1)+CAST('0' AS VARCHAR(1)),1) profit_adj_freq_week_day                               ,
RIGHT(SPACE(2)+CAST('0' AS VARCHAR(2)),2) profit_adj_freq_start_dd                               ,
...
--where AcType in ('06', '3C', '3D', '3G', '3H', '3I', '3J', '3W', '4H', '4L', '4N', '4R')