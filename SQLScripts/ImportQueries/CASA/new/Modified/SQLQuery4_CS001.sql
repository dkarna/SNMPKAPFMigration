...
select m.MainCode
--,count(*) as duplicacy
--'05','07','08','09','10','11','12', '01','02','03','04','28','29'
,case when m.AcType in ('01','05','28') then 'N'
...
case when m.AcType in ('01','05','28') then 'A'
     when m.AcType < '48' and m.TaxPercentOnInt='0' and m.IntPostFrqCr <> '9' and m.TaxPostFrq <> '9' then 'N'
	 when m.AcType < '48' and m.TaxPercentOnInt<> '0' and (m.IntPostFrqCr <> '9' or m.TaxPostFrq <> '9') and m.IntCrRate='0' then 'N'
     else 'S'
end as wtax_level
...
and AcType in ('01','05','07','08','09','0A','0B','0C','0D','0E','0F','0G','0H','0I','0J','0K','0L',
 '0M','0N','0O','0P','0Q','0R','0S','0T','0U','0V','0W','0X','0Y','0Z','10','11','28','29')
 --and AcType not in ('0X')
and Limit !> 0
;
...
,case when t1.TaxPostFrq=9 then RIGHT(SPACE(17)+CAST('0' AS VARCHAR(17)),17)
 ...
 when t1.AcType in  ('01','28','0X') then RIGHT(SPACE(17)+CAST('0' AS VARCHAR(17)),17)
...
,--CASE WHEN t1.AcType NOT In('01','02','03','04','28','29') and t1.AcType <> '0X' THEN 'D' ELSE '' END AS int_freq_type_cr
...
,CASE WHEN t1.AcType = '01' and t1.Balance < 0 THEN 'Q'  ELSE ''   END AS int_freq_type_dr
 --'' AS int_freq_type_dr
,'' AS int_freq_week_num_dr
,'' AS int_freq_week_day_dr
,'' AS int_freq_start_dd_dr
,'' AS int_freq_hldy_stat_dr
,CASE WHEN t1.AcType = '01' and t1.Balance < 0  THEN convert(varchar,GETDATE()+90, 105) ELSE '' END AS next_int_run_date_dr
...
,case when fst.FinacleSchCode='SBSTF' and fet.EmpId is null then 'SBGEN' else fst.FinacleSchCode end AS Schm_code
,case when t1.AcType in ('05','07','0X','0Z','28') then 'N' 
...
and --t1.AcType in ('01','02','03','04','05','07','08','09','0A','0B','0C','0D','0E','0F','0G','0H','0I','0J','0K','0L','0M','0N','0O','0P','0Q',
--'0R','0S','0T','0U','0W','0Y','0Z','10','11','12','3A','3B','3E','3F','3K','3L','3N','3O','3P','3Q','3R','3S','3T','3U','3V','3X','3Y','3Z','4A',
...
t1.AcType In ('01','05','07','08','09','0A','0B','0C','0D','0E','0F','0G','0H','0I','0J','0K','0L',
 '0M','0N','0O','0P','0Q','0R','0S','0T','0U','0V','0W','0X','0Y','0Z','10','11','28','29')
--and t1.AcType not in ('0X')
--and t1.ClientCode <> '00408728'
--and fst.FinacleSchCode not in ('SBAUD','SBCAD','SBEUR','SBGBP','SBUSD', 'CLFCY')
--and t2.ClientCode in ('00148446', '00330073')
and t2.ClientStatus <> 'Z'
--and fet.EmpId is not null
AND EXISTS
(
