...
,case when t1.IntPostFrqCr = 4 then 'M' 
 when t1.IntPostFrqCr in (5,6) then 'Q'
 when t1.IntPostFrqCr = '7' then 'Y'
 else 'D'
...
,'' AS free_code_10
,'' AS int_tbl_code
,left(t2.Address1,5) AS acct_loc_code
