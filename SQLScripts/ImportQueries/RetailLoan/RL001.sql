...
(
	...
	,dep.Reference AS rel_deposit_acid    -- Reference NUMBER from DependancyTable
	...
	JOIN #tempFinacleLoanTable flt ON m.MainCode = flt.PumoriMainCode AND m.AcType = flt.PumoriAcType AND m.CyCode = flt.PumoriCyCode -- use the join from master table
