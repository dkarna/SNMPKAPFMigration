...
,CASE WHEN t2.DateOfBirth IS NULL THEN REPLACE(REPLACE(CONVERT(VARCHAR,'01-01-1900',106), ' ','-'), ',','')
ELSE
...
,'F' AS MINOR_GUARD_CODE  --changed to default father code 'F'
