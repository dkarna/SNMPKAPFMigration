...
JOIN Master m ON t1.MainCode = m.MainCode AND m.ClientCode = t1.ClientCode and m.BranchCode = t1.BranchCode, ControlTable ctb
WHERE  len(m.ClientCode) >= 8
and left(m.ClientCode,1)<>'_'
and m.IsBlocked NOT IN ('C','o')
and t2.MaturityDate > ctb.Today
and EXISTS
(
