...
AcOpenDate start_date                                             ,
'31/12/2099' end_date                                               ,
C.ClientCode cust_id                                                ,
NULL cust_reltn_code                                        ,
'Y' pass_sheet_flg                                         ,	
'Y' si_flg                                                 ,	
'Y' td_matrty_flg                                          ,	
'Y' loan_ovrdue_flg                                        ,
...
' ' stmt_cust_id                                           ,
case when lower(Gender) = 'f' or lower(Salutation)  = 'mrs' then 'MS'
when lower(Gender) = 'm' or lower(Salutation)  = 'mr' then 'MR' 
